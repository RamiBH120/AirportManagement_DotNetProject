...
namespace AM.ApplicationCore.Services
{
    public class ServiceFlight :Service<Flight>, IServiceFlight
    {
        ...
        public IEnumerable<Staff> getstaffs(int volID)
        {
            return GetById(volID).Passengers.OfType<Staff>();
        }

        public IEnumerable<Traveller> GetTravellers(Plane plane, DateTime DateVol)
        {
            return GetMany(
                f=>f.FlightDate.Equals(DateVol) && plane.PlaneId==f.Plane.PlaneId
                )
